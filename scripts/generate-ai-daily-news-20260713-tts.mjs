#!/usr/bin/env node
// Generate per-scene TTS audio for AiDailyNews20260713
...
const BEATS = [
  {
    ...
    style: "Calm Chinese news anchor, precise, professional and well-paced",
    expectedDurationSeconds: 28,
  },
  {
    id: "meta-infra",
    narration:
    ...
    style: "Chinese business news narrator, clear and factual, urgent but controlled",
    expectedDurationSeconds: 28,
  },
  {
    id: "waze-voice",
    ...
    style: "Light Chinese technology narrator, conversational and upbeat",
  ...
  },
  {
    ...
    style: "Chinese technology analyst, enthusiastic but precise, forward-looking",
  ...
  },
  {
    ...
    style: "Chinese tech explainer, clear and structured, analytical",
    expectedDurationSeconds: 22,
  },
  {
    id: "us-policy",
    ...
    style: "Chinese policy reporter, calm and measured, factual tone",
  ...
  },
  {
    ...
    style: "Chinese regulatory analyst, careful and precise, disclaimers respected",
  ...
  },
  {
    ...
    style: "Chinese finance correspondent, direct and decisive, noting the scale",
    expectedDurationSeconds: 22,
  },
  {
    id: "china-signal",
    ...
    style: "Chinese geopolitical reporter, neutral and analytical, observing trends",
    expectedDurationSeconds: 20,
  },
  {
    id: "trend-summary",
    ...
    style: "Chinese news anchor, fast-paced but clear, key terms emphasized",
    expectedDurationSeconds: 24,
  },
  {
    id: "close",
    ...
    style: "Chinese tech commentator, thoughtful and forward-looking, advisory tone",
...
const genForBeat = async (beat, idx) => {
  ...
  const plan = {
    brief: `Generate Chinese AI daily news narration for: ${beat.id}`,
    ...
    title: `AI Daily News 2026-07-13 ${beat.id}`,
  };
...
const main = async () => {
  ...
  const ts = `// Auto-generated by scripts/generate-ai-daily-news-20260713-tts.mjs
...
`;
  ...
  if (results.length < BEATS.length) {
    console.log(`  ${BEATS.length - results.length} scenes will need fallback.`);
  }
};
