...
export { buildVisualReviewStillAnalysisFindings } from "./visual-review-still-findings";
...
const analyzePngBuffer = (buffer: Buffer): VisualReviewStillAnalysis => {
  ...
  const fineDetailRatio = detailComparisonCount > 0 ? fineDetailCount / detailComparisonCount : 0;
